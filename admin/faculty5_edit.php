...
<?php
 if(isset($_POST['edit_data_btn5']))
 {
    $id = $_POST['edit_id5'];

    $query = "SELECT * FROM faculty5 WHERE id ='$id' ";
...
?>
            ...
            <a href="faculty5.php" class="btn btn-danger" >Cancel</a>
                <button type="submit" name="faculty5_update" class="btn btn-primary">Update</button>
            </div>
            </form>
<?php
    }
