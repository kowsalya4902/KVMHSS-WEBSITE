...
<?php
 if(isset($_POST['edit_data_btn4']))
 {
    $id = $_POST['edit_id4'];

    $query = "SELECT * FROM faculty4 WHERE id ='$id' ";
...
?>
            ...
            <a href="faculty4.php" class="btn btn-danger" >Cancel</a>
                <button type="submit" name="faculty4_update" class="btn btn-primary">Update</button>
            </div>
            </form>
<?php
    }
