<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="navbar">
          ...
          <br>
        <marquee><b><h1 style="color: rgb(15, 122, 151); font-family: 'Poppins', sans-serif;">ENGLISH DEPARTMENT</h1></b></marquee>  
              ...
              <div class="card swiper-slide">
                        <div class="image-content">
                            ...
                            <div class="card-image">
                                <img src="../admin/upload2/<?php echo $row['images']; ?>" alt="" class="card-img">
                            </div>
                        </div>
